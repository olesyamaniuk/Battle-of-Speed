document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".battle-navigation-list");
  const headerRef = document.querySelector(".battle-header");
  const navigationRef = document.querySelector(".battle-navigation");
